...
public:
    ...
    void MapWindow(void);
    void Show(void);
    void Hide(bool=false);

    void TakeSnapshot(void);
    void ShowInCarrousel(const CarrouselRect& rect);
    void RestoreSnapshot(void);

    void UpdateTitlebar(void);
    void UpdateAllAttributes(void);
	std::list<WaAction*> *GetActionList(list<WaActionExtList *> *);
	...
	bool showing_carrousel, showing_hidden, hidden;
...
private:
	...
	XWindowAttributes snapshot_attrs;
