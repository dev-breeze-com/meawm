...
public:
    ...
    void SetCarrouselDesktop(WaScreen*);
    void GetCarrouselDesktop(WaScreen*);
    void SetShowingDesktop(WaScreen*);
    void GetShowingDesktop(WaScreen*);
    void SetCompositing(WaScreen*);
    void GetCompositing(WaScreen*);
    ...
    Atom net_desktop_viewport, net_desktop_geometry, net_current_desktop,
		net_carrousel_desktop, net_showing_desktop, net_compositing,
    ...
    Atom meawm_net_wm_state_decor, meawm_net_wm_state_decortitle,
        meawm_net_wm_state_decorhandle,
        meawm_net_wm_state_decorborder;
    Atom meawm_net_maximized_restore, meawm_net_virtual_pos,
        meawm_net_wm_desktop_mask;
    Atom meawm_net_wm_merged_to, meawm_net_wm_merged_type,
        meawm_net_wm_merge_order, meawm_net_wm_merge_atfront;
    Atom meawm_net_carrousel, meawm_net_showing, meawm_net_compositing;
    Atom meawm_net_restart, meawm_net_shutdown;
